...
#
    ...
    def make_world(self, batch_dim: int, device: torch.device, **kwargs):
        ...
        entity_filter_agents: Callable[[Entity], bool] = lambda e: not isinstance(e, Agent)
        entity_filter_agent_0: Callable[[Entity], bool] = lambda e: "agent_2" in e.name
        # Add agents
        ...
        for i in range(self.n_obstacles):
            ...
            obstacles = Landmark(
                ...
                mass = 300,
                color=Color.BLACK,
                collision_filter = entity_filter_agent_0
            )
